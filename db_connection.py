...
# --- KODE UNTUK KONEKSI DAN DATA SOLAR TRACKER ---

def create_solar_connection():
    """Membuat koneksi ke database solar tracker yang terpisah."""
    # Konfigurasi dari informasi yang Anda berikan
    db_config = {
        'host': 'localhost',
        'user': 'dbadmin',
        'password': 'DbAdmin123!',
...
def get_solar_tracker_devices():
    """Mengambil semua IMEI dari tabel devices (untuk solar tracker)."""
    ...
    try:
        ...
        print(f"Error getting solar tracker devices: {str(e)}")
        return []
    finally:
